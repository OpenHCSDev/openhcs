...
| C6 | All 30 workflows have reference-value evidence | The historical archive supports 25. All five other pipelines lack file-export modules; this is not evidence of lost exports. Benchmark-only exports and new native/candidate comparisons are being produced separately. Do not promote 25 to 30 until those actual comparisons pass. | Historical question resolved; new evidence pending |
...
| C8 | The benchmark proves preservation across NumPy generations | Run-linked dependency versions were not found in the retained May results or native markers. Current package requirements do not identify that historical environment. Exclude this historical empirical claim. New run-linked versions may support a separately dated, explicitly scoped result. | Resolved: historical claim excluded |
