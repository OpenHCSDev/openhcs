...
**Status**: Theory of Computing-ready | **Lean**: 20251 lines, 880 theorems
...
All theorem-level claims are machine-checked in Lean 4 (20251 lines, 880 theorem/lemma statements). Complexity-class completeness follows by composition with standard complexity results; regime-dependent and physical-transport consequences are proved as assumption-explicit closures.
...
The complete Lean 4 formalization is available in the companion artifact (Zenodo DOI listed on the title page). The mechanization consists of 20251 lines across 88 files, with 880 theorem/lemma statements.
...
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| [[SS1]{.sans-serif}]{#lh:SS1}     | `DecisionQuotient.StochasticSequential.stochastic_sufficiency_pp_complete`                             |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| [[SS2]{.sans-serif}]{#lh:SS2}     | `DecisionQuotient.StochasticSequential.sequential_sufficiency_pspace_complete`                         |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| [[SS3]{.sans-serif}]{#lh:SS3}     | `DecisionQuotient.StochasticSequential.stochastic_sufficiency_pp_hard`                                 |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| [[SS4]{.sans-serif}]{#lh:SS4}     | `DecisionQuotient.StochasticSequential.stochastic_sufficient_in_PP`                                    |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
| [[SS5]{.sans-serif}]{#lh:SS5}     | `DecisionQuotient.StochasticSequential.sequential_sufficient_in_PSPACE`                                |
+-----------------------------------+--------------------------------------------------------------------------------------------------------+
...
-   `DQ.tractable_subcases_conditional`
  ...
  **Paper handle**                                **Status**   **Lean support**
  ...
  `thm:dq-bayes`                                  Full         `DQ.ClaimClosure.DQ4`, `DQ.ClaimClosure.DQ5`, `DQ.ClaimClosure.DQ6`
...
*Auto summary: mapped 151/179 (full=151, derived=0, unmapped=28).*
...
*Auto summary: indexed 179 claims by hardness profile (cost-growth=32; exp-lb-conditional=11; query-lb=8; succinct-hard=6; tractable-structured=12; unspecified=110).*
