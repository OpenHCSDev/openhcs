\section{Conservation Law for Decision-Relevant Coordinates}\label{sec:simplicity-tax}
...
For encoded physical systems, the same redistribution laws apply under declared physical-to-core transport: unresolved coordinates remain per-site external work, while resolved coordinates are paid once in centralized structure.\claimstamp{P\ref{prop:physical-claim-transport};T\ref{thm:tax-conservation},\ref{thm:tax-grows},\ref{thm:amortization}}{AR,LC}
\leanmeta{\LH{CT6},\LH{HD4},\LH{HD21},\LH{HD3}.}
