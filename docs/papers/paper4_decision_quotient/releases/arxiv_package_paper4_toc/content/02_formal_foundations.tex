...
\]
Thus the entropy of the optimizer quotient object is just the base-2 logarithm of the size of the image of $\Opt$.\leanmeta{\LH{IT1},\LH{IT2},\LH{QT5}.}
\end{proposition}
