...
Title: Decision Quotient: Formal Semantics of Architectural Choice
...
- **Inapproximability** within (1 − ε)ln n via L-reduction from SET-COVER [@feige1998threshold]

- **2^(Ω(n)) lower bounds** under ETH via circuit-based arguments [@impagliazzo2001complexity]
