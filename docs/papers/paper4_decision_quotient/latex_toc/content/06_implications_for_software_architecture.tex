...
\begin{proof}
This is the bounded-regime branch of Theorem~\ref{thm:tractable}, mechanized as \LH{L3}.
\end{proof}
...
\begin{proof}
This is the separable-utility branch of Theorem~\ref{thm:tractable}, mechanized as \LH{L4}.
\end{proof}
...
\begin{proof}
This is the tree-factor branch of Theorem~\ref{thm:tractable}, mechanized as \LH{L5}.
\end{proof}
...
\begin{proof}
This is the mechanized theorem \LH{HD10}.
\end{proof}
