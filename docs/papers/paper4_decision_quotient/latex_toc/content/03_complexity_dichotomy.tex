...
\begin{enumerate}
\item Bounded actions $\to$ P \quad \leanmeta{\LH{CC7}}
\item Separable utility $\to$ P \quad \leanmeta{\LH{CC55}}
\item Low tensor rank $\to$ P \quad \leanmeta{\LH{CC113}}
\item Tree structure $\to$ P \quad \leanmeta{\LH{CC115}}
\item Bounded treewidth $\to$ P \quad \leanmeta{\LH{CC117}}
\item Coordinate symmetry $\to$ P \quad \leanmeta{\LH{DQ592}}
\end{enumerate}
\leanmeta{\LH{DQ592}.}
\end{theorem}
