...
\end{itemize}
Under these constraints, Bayesian updating is the \emph{unique} admissible rule \LH{BB3}. Any two admissible rules must agree \LH{BB5}. This is ``Bayes from physics''---the thermodynamic constraints uniquely determine the correct update rule.
