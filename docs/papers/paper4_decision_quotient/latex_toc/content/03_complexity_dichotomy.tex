...
\leanmeta{\LH{FN7}, \LH{FN8}, \LH{FN12}.}
\end{theorem}
...
\end{itemize}
Under these constraints, Bayesian updating is the \emph{unique} admissible rule \LH{FN12}. Any two admissible rules must agree \LH{FN14}. This is ``Bayes from physics''---the thermodynamic constraints uniquely determine the correct update rule.
