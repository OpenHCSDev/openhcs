...
\begin{enumerate}
\item Either $\phi$ factors through the decision quotient, or it collapses a decision-relevant distinction, i.e., there exist states $s,s' \in S$ such that $\phi(s)=\phi(s')$ but $\Opt(s)\neq\Opt(s')$.
\item If every such extra collapse is mapped to a physically feasible collapse at the canonical requirement profile, then no such extra collapse can occur. Therefore $\phi$ must factor through the decision quotient.
\end{enumerate}
\leanmeta{\LH{AB1},\LH{AB2},\LH{AB3},\LH{AB4}.}
\end{theorem}

\begin{proof}
Part (1) packages the quotient universal property into an explicit dichotomy. If $\phi$ preserves $\Opt$, the existing quotient theorem supplies a factorization through the decision quotient. If $\phi$ does not preserve $\Opt$, then by definition it must identify two states with different optimal-action sets, so it erases a decision-relevant distinction.

Part (2) composes that dichotomy with the already formalized physical no-collapse layer. Once an extra erased distinction is interpreted as a physically feasible collapse, the canonical no-collapse theorem rules it out. The only surviving branch is factorization through the decision quotient.
\end{proof}

Informally: this is the bridge between state-space abstraction and complexity-class collapse. At the state level, the decision quotient is the maximal lossless collapse. At the physical-complexity level, any claim that a coarser collapse remains feasible must pass through the same no-collapse obstruction.
...
\leanmeta{\LH{PS1},\LH{PS2},\LH{PS3},\LH{PS4},\LH{OR3},\LH{OR4},\LH{OR5},\LH{OR9},\LH{CV4},\LH{CV5},\LH{CV7},\LH{CV17},\LH{CV18},\LH{CV11},\LH{CV12},\LH{CV13},\LH{CV15},\LH{CV16},\LH{CF2},\LH{CF4},\LH{CF6},\LH{CF8},\LH{CF9},\LH{CF7}.}
...
\leanmeta{\LH{PH11},\LH{PH12},\LH{PH13},\LH{PH14},\LH{PH15},\LH{PH16},\LH{PH17},\LH{PH18},\LH{PH19},\LH{PH20},\LH{PH21},\LH{PH22},\LH{PH23},\LH{PH24},\LH{PH25},\LH{PH26},\LH{PH27},\LH{PH28},\LH{PH29},\LH{PH30},\LH{PH31},\LH{PH32},\LH{PH33},\LH{GN2},\LH{GN4},\LH{GN5},\LH{GN6},\LH{GN7},\LH{GN8},\LH{GN9},\LH{GN10},\LH{GN11},\LH{GN12},\LH{GN13},\LH{CC18},\LH{CC30},\LH{CC21}.}
