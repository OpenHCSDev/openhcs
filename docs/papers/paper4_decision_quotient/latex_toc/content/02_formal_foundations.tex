...
The core definitions in this section are substrate-neutral: they specify the decision relation independently of implementation medium. Physical interpretation is introduced later through explicit encoding and assumption-transfer maps (Section~\ref{sec:physical-transport}).\claimstamp{D\ref{def:physical-core-encoding};P\ref{prop:physical-claim-transport};T\ref{thm:physical-bridge-bundle}}{AR}
\leanmeta{\LH{CT6},\LH{CT4}.}
Physical-state semantics are typed by a realizable state set: any state marked physical has an instance witness, and state-level claims transport over all physical states without substrate-specific axioms.
\leanmeta{\LH{PS1},\LH{PS2},\LH{PS3},\LH{PS4}.}
Observer classes induce effective quotient state spaces on the same physical domain; witness pairs certify observer-relative collapses/separations.
\leanmeta{\LH{OR3},\LH{OR4},\LH{OR5},\LH{OR9}.}
Two recurrent circuits coupled by a shared channel node are formalized with clamp-observed state, one-bit decision-event lower bounds, and typed YES/NO/ABSTAIN report projection into the claim-admissibility layer.
\leanmeta{\LH{CV4},\LH{CV5},\LH{CV7},\LH{CV8},\LH{CV9},\LH{CV11},\LH{CV12},\LH{CV13},\LH{CV15},\LH{CV16}.}
Under separating physical parameterizations, logic/time scaffolds do not determine a unique timed law/objective; deadline forcing yields forced action with positive Landauer/NV lower bounds, and with uncertainty yields nondegenerate belief.
\leanmeta{\LH{CF2},\LH{CF4},\LH{CF6},\LH{CF8},\LH{CF9},\LH{CF7}.}
Physical-collapse transfer is isolated as a conditional chain at requirement and canonical levels: declared collapse-map schema implies no physical collapse and yields the canonical \(P{=}NP\) physical-impossibility specialization. The map is also derived from an explicit SAT witness plus reduction-energy transport, and collapse is bounded by the sharp disjunction (unbounded budget or zero bit-cost or failed exponential lower bound) under bounded-budget/positive-cost/exponential-lower-bound premises; deterministic/probabilistic/sequential variants preserve the same form.
\leanmeta{\LH{PH11},\LH{PH12},\LH{PH13},\LH{PH14},\LH{PH15},\LH{PH16},\LH{PH17},\LH{PH18},\LH{PH19},\LH{PH20},\LH{PH21},\LH{PH22},\LH{PH23},\LH{PH24},\LH{PH25},\LH{PH26},\LH{PH27},\LH{PH28},\LH{PH29},\LH{PH30},\LH{PH31},\LH{PH32},\LH{PH33}.}
A layered graph module composes cycle witnesses, observer surprisal-plus-novelty nontriviality, entropy-normalized DQ, forced-belief/Bayes-update bridge, and thermodynamic/material lower-bound witnesses.
\leanmeta{\LH{GN2},\LH{GN4},\LH{GN5},\LH{GN6},\LH{GN7},\LH{GN8},\LH{GN9},\LH{GN10},\LH{GN11},\LH{GN12},\LH{GN13}.}
It also fixes the exact-claim admissibility boundary: exact reports require a certified-bit gap over raw payload, hardness-blocked exact claims collapse to raw-only accounting, and integrity/competence cannot both hold universally under hardness-blocked resources.\claimstamp{T\ref{thm:exact-certified-gap-iff-admissible};P\ref{prop:integrity-resource-bound};C\ref{cor:hardness-raw-only-exact}}{AR}
\leanmeta{\LH{CC18},\LH{CC30},\LH{CC21}.}
...
In this paper, normative modal statements denote contract-conditional necessity: once an agent declares an objective/regime/assumption contract, admissible policy is fixed by typed admissibility and integrity under that contract.
...
\]
\leanmeta{\LH{DT13},\LH{DT11},\LH{DT10},\LH{DT12}.}
\end{proposition}
...
\]
\leanmeta{\LH{DT15},\LH{DT16},\LH{DT18},\LH{DT19}.}
\end{proposition}
...
\leanmeta{\LH{DT22},\LH{DT23},\LH{DT24}.}
\end{proposition}
...
\leanmeta{\LH{HS3}, \LH{HS5}, \LH{HS6}.}
\end{proposition}

\begin{proposition}[Conditional Physical Claim Transport]\label{prop:physical-claim-transport}
...
\leanmeta{\LH{CC11}, \LH{IC11}, \LH{IC10}, \LH{IC16}, \LH{IC15}, \LH{IC13}, \LH{IC14}, \LH{IC18}, \LH{IC19}.}
\end{proposition}
...
\]
\leanmeta{\LH{CC18}, \LH{CC20}, \LH{CC17}, \LH{IC31}.}
\end{theorem}
