...
The chain from counting to Decision Quotient:
\begin{enumerate}
...
\noindent\textbf{Consequence.} Rate-distortion theory independently recovers structural rank as the minimal description length for decision-making. Pure Shannon theory.
