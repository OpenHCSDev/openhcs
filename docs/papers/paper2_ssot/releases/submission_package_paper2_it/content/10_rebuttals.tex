...
\textbf{Response:} The optimality is \textbf{derived}, not chosen. DOF = 1 is the unique optimal encoding rate under coherence constraints (\LH{UNQ1}, \LH{RED1}):
...
\end{code}
The impl exists; the registry entry does not. \textbf{DOF = 2}: the impl and the registry are independent locations that can disagree (\LH{RED1}).
