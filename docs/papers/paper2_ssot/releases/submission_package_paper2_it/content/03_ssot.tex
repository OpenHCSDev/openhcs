...
DOF = 1 is not a design guideline. It is the information-theoretically optimal rate guaranteeing coherence for facts encoded in systems with modification constraints (\LH{COH1}, \LH{COH2}, \LH{BND1}).
...
\end{corollary}
\leanmeta{\LH{COH1}, \LH{TRI1}, \LH{UNQ1}}
...
Our contribution is proving that SSOT is not a heuristic but an information-theoretic optimality condition (\LH{COH1}, \LH{COH2}, \LH{COH3}).
...
\end{corollary}
\leanmeta{\LH{INS3}, \LH{TRI1}, \LH{UNQ1}, \LH{MDL5}}
...
\end{corollary}
\leanmeta{\LH{COH2}, \LH{TRI1}, \LH{ADV2}}
...
\end{theorem}
\leanmeta{\LH{DER2}, \LH{TRI1}, \LH{MDL3}}
