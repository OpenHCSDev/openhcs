...
DOF = 1 is not a design guideline. It is the information-theoretically optimal rate guaranteeing coherence for facts encoded in systems with modification constraints (\LH{COH1}, \LH{COH3}, \LH{BND2}).
...
\end{corollary}
\leanmeta{\LH{COH1}, \LH{UNQ1}, \LH{UNQ1}}
...
Our contribution is proving that SSOT is not a heuristic but an information-theoretic optimality condition (\LH{COH1}, \LH{COH3}, \LH{COH3}).
...
\end{corollary}
\leanmeta{\LH{L1}, \LH{UNQ1}, \LH{UNQ1}, \LH{ORA1}}
...
\end{corollary}
\leanmeta{\LH{COH3}, \LH{UNQ1}, \LH{AXM1}}
...
\end{proof}
See the formal Zero-Incoherence Capacity statement in Section~\ref{sec:capacity} (Theorem~\ref{thm:coherence-capacity}, \LH{COH3}). A concise proof sketch appears below; the full mechanized proof is provided in Supplement~A.
...
\end{theorem}
\leanmeta{\LH{DES1}, \LH{UNQ1}, \LH{ORA1}}
