...
\begin{proof}
With declared attribute sets (interfaces in the PL instantiation), the constraint ``$v$ must satisfy attribute $I$'' requires verifying that each class satisfies all attributes in $I$. For $k$ classes, $O(k)$ locations.
\end{proof}
